          ...
          <>
            ...
            <div className="lg:hidden absolute left-0 right-0 top-full z-50 border-t bg-white shadow-lg py-4 px-4 sm:px-6">
              ...
              <div className="overflow-hidden">
                ...
                >
                  {/* === Panel ROOT (col 1) === */}
                  {/* MODIFIED: removed space-y-2 and standardized row heights */}
                  <nav className="w-1/2 pr-4 flex flex-col">
                    <Link
                      to="/"
                      className={`w-full flex items-center py-3 min-h-[44px] leading-none transition-colors ${
                    ...
                    {/* MODIFIED: same row height/style as links */}
                    <button
                      type="button"
                      className={`w-full flex items-center justify-between py-3 min-h-[44px] leading-none transition-colors ${
                        isAboutActive ? "text-teal-600 font-semibold" : "text-gray-700 hover:text-teal-600"
                      }`}
