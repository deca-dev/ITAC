...
export const courses: Course[] = [
  {
    ...
    title:
      "Diplomado en Fundamentos de Terapia Dialéctica Conductual (7ma Generación)",
    subtitle:
...
`,
  },
  {
    ...
    subtitle:
      "Logrando los más altos estándares de calidad en DBT para equipos clínicos.",
...
`,
  },
  {
    ...
    dates:
      "1ra parte: 5, 6 y 7 diciembre, 2025\n2da parte: 24, 25 y 26 julio, 2025",
...
`,
  },
  {
    ...
    subtitle:
      "Capacitación avanzada en DBT con Kelly Koerner, PhD, experta internacional y autora de guías prácticas.",
    dates: "6 y 7 de junio de 2026",
    schedule: "9am a 6pm",
    mode: "Presencial en Guadalajara, México",
    text: `
<p><strong>PONENTE:</strong><br/>Kelly Koerner, PhD es terapeuta, supervisora clínica y entrenadora en DBT reconocida internacionalmente. Es autora de “Doing Dialectical Behavior Therapy: A Practical Guide” y coautora de “Dialectical Behavior Therapy in Clinical Practice: Second Edition”. Ha enseñado en la Universidad de Washington y ha publicado numerosos artículos y capítulos de libros.</p>
<p><strong>Fechas:</strong> 6 y 7 de junio de 2026<br/><strong>Horario:</strong> 9am a 6pm<br/><strong>Modalidad:</strong> Presencial en Guadalajara, México</p>
<p>Dirigido a psicólogos y psiquiatras con formación en fundamentos de DBT.</p>
<p><strong>Inscripciones:</strong> informes@institutodeterapiacontextual.com • +52 55 5554 7420</p>
`,
  },
];
